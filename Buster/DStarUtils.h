...
NS_INLINE uint16 dstar_calc_sum(struct dstar_header_data *header) {
    uint16 crc = 0xFFFF;
    
    for(char *packetPointer = (char *) header; packetPointer < (char *) &(header->sum); ++packetPointer)
...
static const struct dstar_frame dstar_ambe_template = {
    ...
    .id = 0,
    .sequence = 0,
    .ambe.voice = { 0x9E, 0x8D, 0x32, 0x88, 0x26, 0x1A, 0x3F, 0x61, 0xE8 },
    .ambe.data = { 0 },
    .ambe.endPattern = { 0 }
};
